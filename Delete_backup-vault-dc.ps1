...
$VaultName = "backup-vault-dc" #fetch automatically
$Subscription = "Azure subscription 1" #fetch automatically
$ResourceGroup = "rd-dc" #fetch automatically
$SubscriptionId = "56090b3b-8e5e-4ed2-b5a5-895ce4314e49" #fetch automatically
